...
block_num             bigint(10)      NOT NULL   COMMENT '块号' ,
block_id              varchar(40)     NOT NULL   COMMENT '块ID' ,
pre_block_id          varchar(40)                COMMENT '上一个块ID',
block_timestamp       datetime                   COMMENT '产块时间' ,
signature_delegate    varchar(40)                COMMENT '产块代理' ,
num_trxs              int(4)                     COMMENT '块中交易数量' ,
block_size            bigint(10)                 COMMENT '块的大小' ,
sync_timestamp        datetime                   COMMENT '开始同步时间' ,
processing_time       bigint(20)                 COMMENT '处理时间' ,
